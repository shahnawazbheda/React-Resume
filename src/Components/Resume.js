                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div className="text-center">
                                            <div className="flex justify-center">
                                                <img className="max-w-xs rounded-xl transition duration-100 ease-in-out hover:scale-110 m-3 max-w-[50%]" src="my.jpg" alt="User Image" />
                                            </div>
                                        </div>
                                ...
                                <div className="p-5">
                                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-7">
                                        <div className="col-span-2 sm:col-span-1 md:col-span-1 lg:col-span-2">
                                            ...
                                            <p className="mt-4">Hello! I'm Shahnawaz Bheda, a passionate React developer with a knack for creating dynamic and engaging web applications.</p>
                                            <button type="button" className="mt-5 text-gray-900 bg-white hover-bg-gray-100 border border-gray-200 focus-ring-4 focus:outline-none focus-ring-gray-100 font-medium rounded-0 text-sm px-5 py-2.5 text-center inline-flex items-center  dark-hover-bg-gray-700 mr-2 mb-2">
                                                DOWNLOAD RESUME
                                            </button>
                                        </div>
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <a href="#" className="block mt-5 p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100">
                                                <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-black">Specialization Course</h5>
                                                <p className="font-normal text-gray-700 dark:text-gray-700">Mauris magna sapien, pharetra consectetur fringilla vitae, interdum sed tortor</p>
                                            </a>
                                        ...
                                        <div>
                                            ...
                                            <a href="#" className="block p-6 mt-5 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 ">
                                                <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-black">Graphic Designer</h5>
                                                <p className="font-normal text-gray-700 dark:text-gray-700">Mauris magna sapien, pharetra consectetur fringilla vitae, interdum sed tortor.</p>
                                            </a>
                                        </div>
                                    </div>
                    ...
                    <div className={contentClasses}>
                        <div className="container mx-auto px-4 mt-5">
                            <div className="bg-white border rounded-3xl shadow">
                                ...
                                <div className="p-5">
                                    <p className='font-bold text-3xl'>My <span style={{ color: '#2ECA7F' }}>Services</span></p>


                                    <div className="grid grid-cols-2 gap-4 mt-5">
                                        <div>

                                            <a href="#" className="block  p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 ">
                                                <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-gray-900">Front-End developer</h5>
                                                <h5 className="mb-2 text-xl font-bold tracking-tight text-gray-900 dark:text-gray-900">ReactJs , NextJS</h5>
                                                <p className="font-normal text-gray-700 dark:text-gray-700">As a frontend developer, I specialize in creating visually stunning, responsive, and user-friendly interfaces. Whether you have a design in mind or need me to design from scratch, I use the latest technologies and best practices to make sure your website captures the attention of your visitors.</p>
                                            </a>
                                        ...
                                        <div>
                                            ...
                                            <a href="#" className="block  p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 " style={{ height: '100%' }}>
                                                <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-gray-900">Back-End Development</h5>
                                                <h5 className="mb-2 text-xl font-bold tracking-tight text-gray-900 dark:text-gray-900">Node.js , NextJS</h5>
                                                <p className="font-normal text-gray-700 dark:text-gray-700">In the world of web development, a strong backend is the backbone of your website. I excel in building robust and secure server-side applications that handle data, transactions, and user interactions seamlessly.</p>
                                            </a>
                            ...
                            <div className="bg-white border rounded-3xl shadow">
                                ...
                                <div className="p-5">
                                    <div className="grid p-3 grid-cols-2 gap-4 mt-5">
                                        <div className='ms-2'><img src='medicare.JPG' /></div>
                                        <div className='ms-2'><img src='Movie.JPG' /></div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="p-5">
                                    <div className="grid grid-cols-2 gap-4 p-3">
                                        <div className='text-xl'>
                                            <p className="text-2xl font-bold">Get in  <span className="text-green-500">Touch</span></p>
                                            <p className='fa fa-map-marker mt-12  ms-1 text-green-500'><span className='ms-2 font-bold text-black'>Bajarangvadi, Rajkot</span></p> <br />
                                            <p className='fa fa-envelope mt-5  text-green-500'><span className='ms-2 font-bold text-black'>shahnawazbheda@gmail.com</span></p><br />
                                            <p className='fa fa-phone mt-5  text-green-500'><span className='ms-2 font-bold text-black'>+91 9558362840</span></p><br />
                                            <p className='fa fa-check mt-5   text-green-500'><span className='ms-2 font-bold text-black'>Freelance Available</span></p>
                                        </div>

                                        <div>
                                            <p className="text-2xl font-bold">Contact  <span className="text-green-500">Us</span></p>
